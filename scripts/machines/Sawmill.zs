...
// Enderman
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_enderman", machineName, 270)
	.addEnergyPerTickInput(64)
	.addItemOutput(<contenttweaker:endermanshard> * 3)
	.addItemInput(<contenttweaker:enderman_orb>)
	.build();
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_endermanD", machineName, 135)
	.addEnergyPerTickInput(128)
	.addItemOutput(<contenttweaker:endermanshard>)
	.addItemInput(<contenttweaker:enderman_dna>)
	.build();
	
// Wither
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_wither", machineName, 1080)
	.addEnergyPerTickInput(128)
	.addItemOutput(<contenttweaker:withershard> * 3)
	.addItemInput(<contenttweaker:wither_orb>)
	.build();
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_witherD", machineName, 540)
	.addEnergyPerTickInput(256)
	.addItemOutput(<contenttweaker:withershard>)
	.addItemInput(<contenttweaker:wither_dna>)
	.build();