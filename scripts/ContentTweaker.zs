...
// Adroysium Pickaxe
var adroysiumPickaxe = VanillaFactory.createItem("adroysium_pickaxe");
adroysiumPickaxe.register();

// Adroysium Shovel
var adroysiumShovel = VanillaFactory.createItem("adroysium_shovel");
adroysiumShovel.register();

// Enderman Register
var endermanDatamodel as Item = VanillaFactory.createItem("enderman_datamodel");
endermanDatamodel.register();
var endermanOrb as Item = VanillaFactory.createItem("enderman_orb");
endermanOrb.register();
var endermanData as Item = VanillaFactory.createItem("enderman_data");
endermanData.register();
var endermanShard as Item = VanillaFactory.createItem("endermanshard");
endermanShard.register();
var endermanDNA as Item = VanillaFactory.createItem("enderman_dna");
endermanDNA.register();
var endermanSuper as Item = VanillaFactory.createItem("red_enderman");
endermanSuper.register();

// Wither Register
var witherDatamodel as Item = VanillaFactory.createItem("wither_datamodel");
witherDatamodel.register();
var witherOrb as Item = VanillaFactory.createItem("wither_orb");
witherOrb.register();
var witherData as Item = VanillaFactory.createItem("wither_data");
witherData.register();
var witherShard as Item = VanillaFactory.createItem("withershard");
witherShard.register();
var witherDNA as Item = VanillaFactory.createItem("wither_dna");
witherDNA.register();
var witherSuper as Item = VanillaFactory.createItem("red_wither");
witherSuper.register();

// Bewithered Dust
var bewitheredDust = VanillaFactory.createItem("bewithered_dust");
bewitheredDust.register();

// Bewithered Leather
var bewitheredLeather = VanillaFactory.createItem("bewithered_leather");
bewitheredLeather.register();

// Creative Key
var creativeKey = VanillaFactory.createItem("creative_key");
creativeKey.register();